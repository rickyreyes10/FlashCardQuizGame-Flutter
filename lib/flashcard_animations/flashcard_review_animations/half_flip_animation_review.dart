...
class HalfFlipAnimationR extends StatefulWidget {
  const HalfFlipAnimationR(
      {required this.child,
  ...
  @override
  State<HalfFlipAnimationR> createState() => _HalfFlipAnimationState();
}

class _HalfFlipAnimationState extends State<HalfFlipAnimationR>

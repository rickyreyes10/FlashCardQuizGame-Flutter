...
class SlideAnimationR extends StatefulWidget {
  const SlideAnimationR(
      {required this.child,
  ...
  @override
  State<SlideAnimationR> createState() => _SlideAnimationState();
}

class _SlideAnimationState extends State<SlideAnimationR>
